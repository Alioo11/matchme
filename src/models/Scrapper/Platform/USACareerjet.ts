...
class USACareerjetScrapper implements IScrapper {
  ...
  private platformBaseURL = "https://www.careerjet.com";
  ...
  startIndexing = async (limit: number) => {
    ...
    try {
      ...
      for (let i = 0; i < 100; i++) {
        ...
        await page.goto(`${this.platformBaseURL}/jobs?s=frontend&l=USA&sort=relevance&p=${i}`, { timeout: 10000 });
...
export default USACareerjetScrapper;
